...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        world.addGameObjects(WallFactory.createWalls(
        ...
        world.addGameObject(new SpiderWeb(
        ...
        world.addGameObject(new HalfSolidBunker(
