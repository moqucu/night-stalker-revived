...
public class DisplayableSprite extends ImageView implements Sprite {

    @Getter
    protected DisplayableObject model = new DisplayableObject() {
    };
    ...
    private void setDisplayableObjectModel(DisplayableObject model) {
    ...
    public void setModel(GameObject model) {
        ...
        if (!(model instanceof DisplayableObject))
            throw new RuntimeException("Model needs to be of class DisplayableObject!");
        setDisplayableObjectModel((DisplayableObject) model);
    }
