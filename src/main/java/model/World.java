    ...
    public World() {
        ...
        buildingBlocks.add(
                BuildingBlock.builder()
                        ...
                        .position(Position.builder().horizontal(0).vertical(11).build())
                        .build()
        );
        buildingBlocks.add(
                BuildingBlock.builder()
                        ...
                        .position(Position.builder().horizontal(1).vertical(11).build())
                        .position(Position.builder().horizontal(3).vertical(11).build())
                        .position(Position.builder().horizontal(5).vertical(11).build())
                        .position(Position.builder().horizontal(7).vertical(11).build())
                        .position(Position.builder().horizontal(9).vertical(11).build())
                        .position(Position.builder().horizontal(11).vertical(11).build())
                        .position(Position.builder().horizontal(13).vertical(11).build())
                        .position(Position.builder().horizontal(15).vertical(11).build())
                        .position(Position.builder().horizontal(17).vertical(11).build())
                        .build()
        );
        buildingBlocks.add(
                BuildingBlock.builder()
                        ...
                        .position(Position.builder().horizontal(2).vertical(11).build())
                        .position(Position.builder().horizontal(4).vertical(11).build())
                        .position(Position.builder().horizontal(6).vertical(11).build())
                        .position(Position.builder().horizontal(8).vertical(11).build())
                        .position(Position.builder().horizontal(10).vertical(11).build())
                        .position(Position.builder().horizontal(12).vertical(11).build())
                        .position(Position.builder().horizontal(14).vertical(11).build())
                        .position(Position.builder().horizontal(16).vertical(11).build())
                        .position(Position.builder().horizontal(18).vertical(11).build())
                        .build()
        );
        buildingBlocks.add(
                BuildingBlock.builder()
